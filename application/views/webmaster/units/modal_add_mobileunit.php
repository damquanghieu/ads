...
<div class="modal fade" id="add-mobileunit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e('Добавление мобильного блока'); ?></h4>
            </div>
...
<!--                        </div>-->
            ...
            <div class="modal-footer">
                ...
                <button v-if="!is_complete" @click="addMobileUnit" v-bind:disabled="button_active"
