...
<div class="modal fade" id="edit-bannerunit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php _e('Редактирование блока'); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button @click="updateBannerUnit" v-bind:disabled="button_active" class="btn btn-primary">
