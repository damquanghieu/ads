...
<div class="modal fade" id="edit-dsa" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4><?php _e('Редактирование обьявления'); ?> [ID:{{ad_id}}]</h4>
            </div>
            <div class="modal-body">

                <div class="row form-group">
                    <div class="col-md-12">
                        <div class="advertiser-preview-image-box">
                            <img v-bind:src="img_src || '/assets/imgs/no-image.png'">
                        </div>
                    </div>
                </div>
