...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Баннеры'); ?> > <?php _e('Кабинет рекламодателя'); ?></title>
        <meta name="csrf" content="<?php csrf_token(); ?>">
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <?php include_once dirname(dirname(__DIR__)) . "/_styles.php"; ?>
        <?php print_js_var('ALLOWED_BANNER_SIZES', config_item('banners_sizes')) ?>
    ...
    <body class="hold-transition skin-green fixed sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        ...
                        <button data-target="#add-banner" data-toggle="modal" data-backdrop="static" data-keyboard="false" class="btn bg-green btn-sm">
                            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;
                            <?php _e("Добавить Баннер"); ?>
                        </button>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"> <?php _e('Баннеры'); ?></li>
                    </ol>
                </section>
        ...
        <?php include_once __DIR__ . "/modal_add_banner.php"; ?>
        <?php include_once __DIR__ . "/modal_edit_banner.php"; ?>
