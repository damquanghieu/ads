...
<div class="modal fade" id="add-banner" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4><?php _e('Добавление баннера'); ?></h4>
            </div>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <div v-if="!img_src" class="advertiser-upload-banner-box">
                            ...
                            <div>
                                <strong><?php _e('Разрешенные размеры баннеров:'); ?></strong>
                                <p class="text-muted">{{allowed_sizes.join(', ')}}</p>
                            </div>
                        </div>

                        <div v-else class="advertiser-preview-banner-box">
            ...
            <div v-else>
                <div class="modal-footer">
                    <button @click="resetInputFile" v-bind:disabled="!img_src" class="btn btn-danger pull-left"><?php _e('Сбросить изображение') ?></button>
                    <button @click="addBanner" v-bind:disabled="active_button" class="btn btn-success">
