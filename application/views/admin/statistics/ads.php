...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по обьявлениям'); ?> > <?php _e('Кабинет админиcтратора'); ?></title>
        ...
        <?php print_js_var('filter_camp_id', $filter_camp_id); ?>
    </head>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="filter-box">
                                    ...
                                    <div class="filter-item">
                                        ...
                                        <a href="/administrator/statistics/ads" class="close"><span>×</span></a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="filter-box">
                                    ...
                                    <div class="filter-item">
                                        <i class="fa fa-fw fa-filter"></i>
                                        <?php echo "Camp ID: " . $filter_camp_id; ?>
                                        <a href="/administrator/statistics/ads" class="close"><span>×</span></a>
                                    </div>
                                </div>
                            ...
                            <div class="box box-danger">
                                <div class="box-body table-responsive">
                                    <table id="_datatable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th><?php _e('ID обьявления'); ?></th>
                                                <th><?php _e('ID кампании'); ?></th>
