...
<html>
    <head>
        ...
        <title><?php echo get_globalsettings('custom_name', 'AdFlex')?> > <?php _e('Статистика по кампаниям'); ?> > <?php _e('Кабинет админиcтратора'); ?></title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="filter-box">
                                    ...
                                    <div class="filter-item">
                                        ...
                                        <a href="/administrator/statistics/camps" class="close"><span>×</span></a>
                                    </div>
                                </div>
