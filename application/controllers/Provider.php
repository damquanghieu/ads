...
class Provider extends CI_Controller
{
    ...
    private function getThirdPartyCode($site_obj, $unit_obj)
    {
        ...
        //if ($site_obj->isolated == 1 && $unit_obj->params->third_party_code == "" && get_globalsettings('default_third_party_code') != "") {
        if ($unit_obj->params->third_party_code == "" && get_globalsettings('default_third_party_code') != "") {
            return [
                "third_party_status" => get_globalsettings('default_third_party_status'),
                "third_party_code"   => get_globalsettings('default_third_party_code')
            ];
        }
